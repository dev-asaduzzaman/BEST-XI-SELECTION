...
const PlayerCard = ({player}) => {
    ...
    return (
        <div className="card shadow-sm p-4 rounded-lg bg-white">
          <figure>
            <img
          ...
          <div>
            ...
            <div className="card-actions flex justify-between items-center mt-3">
              ...
              <button disabled={isSelected} onClick={() => setIsSelected (true) } className="btn sora bg-[#F3F3F3] border-none text-[#000000] shadow">
